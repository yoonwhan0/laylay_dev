...
const QUESTIONS = [
  {
    ...
    badge: "RECOVERY",
    text: "오늘 아침, 알람이 울리고\n실제로 일어나기까지 걸린 시간은?",
    lead: "오늘의 첫 번째 ‘움직임 시작 난이도’를 가볍게 체크해요.",
    why: {
      body:
        "수면시간 자체만큼 ‘아침에 얼마나 회복됐다고 느끼는지’도 오늘 컨디션을 설명하는 데 유용한 생활 신호입니다. 이 문항은 임상 척도를 복제하지 않은 레이레이 자체 문항입니다.",
      reference: "참고 개념: CDC 수면 가이드 · 주관적 수면/회복 상태",
    },
    options: [
  ...
  },
  {
    ...
    lead: "아침 인지 선명도를 간단히 살펴봐요.",
    why: {
      body:
        "아침에 머리가 맑은지, 멍한지는 그날의 집중·의사결정 리듬을 미리 알려주는 신호입니다. 임상 진단이 아니라 오늘의 인지 컨디션을 스스로 체크하는 레이레이 문항입니다.",
      reference: "참고 개념: 주관적 각성/집중도 · 일상 인지 피로",
    },
    options: [
  ...
  },
  {
    ...
    badge: "ENERGY",
    text: "오늘 점심 후,\n가장 하고 싶은 건?",
    lead: "오후로 넘어가는 에너지 방향을 확인해요.",
    why: {
      body:
        "점심 이후 하고 싶은 행동은 남은 하루의 활동 여력을 보여주는 생활 지표입니다. 의학적 평가가 아니라, 오늘 몸의 에너지 흐름을 읽는 레이레이 자체 문항입니다.",
      reference: "참고 개념: 주간 활동 에너지 · 식후 각성 변화",
    },
    options: [
  ...
  },
  {
    ...
    lead: "할 일에 대한 시작 동기를 체크해요.",
    why: {
      body:
        "할 일 목록을 볼 때의 반응은 동기·부담감·회피 경향을 빠르게 드러냅니다. 생산성 진단이 아니라 오늘의 추진력 상태를 가볍게 포착하기 위한 문항입니다.",
      reference: "참고 개념: 행동 동기 · 과제 회피/시작 지연",
    },
    options: [
  ...
  },
  {
    ...
    badge: "BODY",
    text: "오늘 몸의 무게감은?",
    lead: "신체 피로와 움직임 저항감을 살펴봐요.",
    why: {
      body:
        "몸이 가볍거나 무거운 감각은 수면·활동량·스트레스가 몸에 남긴 흔적을 반영합니다. 임상 검사 대신, 주관적 신체 컨디션을 스스로 기록하는 레이레이 문항입니다.",
      reference: "참고 개념: 주관적 피로 · 신체 활력 인식",
    },
    options: [
  ...
  },
  {
    ...
    lead: "사회적 에너지 잔량을 가볍게 확인해요.",
    why: {
      body:
        "사람을 만나고 싶은 정도는 정서적 여유와 사회적 배터리 상태를 보여줍니다. 성격 진단이 아니라, 오늘 관계 에너지의 방향을 읽는 레이레이 자체 문항입니다.",
      reference: "참고 개념: 사회적 에너지 · 주관적 상호작용 여유",
    },
    options: [
  ...
  },
  {
    ...
    badge: "EVENING",
    text: "오늘 저녁, 집에 가면?",
    lead: "하루 마무리 루틴의 회복 니즈를 봐요.",
    why: {
      body:
        "저녁에 무엇을 하고 싶은지는 하루를 어떻게 회복할지에 대한 신호입니다. 수면 위생 교육용 체크가 아니라, 오늘 밤의 회복 모드를 스스로 고르는 문항입니다.",
      reference: "참고 개념: 저녁 회복 행동 · 수면 준비 루틴",
    },
    options: [
  ...
  },
  {
    ...
    lead: "현재 욕구의 방향을 한 줄로 정리해요.",
    why: {
      body:
        "지금 가장 끌리는 선택은 활동·휴식·수면 중 어디를 몸이 원하는지 보여줍니다. 최종 상태 요약용 레이레이 문항이며, 임상 척도를 복제하지 않습니다.",
      reference: "참고 개념: 현재 욕구 방향 · 활동/휴식 밸런스",
    },
    options: [
...
const RESULT_COPY = {
  Active: {
    title: "오늘은 활력 충전 완료!",
    desc: "에너지가 넘치는 날이에요. 이 기세로 차분히 이어가 보세요.",
    tags: ["아침형 인간", "생산성 MAX", "오늘의 MVP"],
  },
  Easy: {
    title: "슬슬... 레이지해지는 중",
    desc: "오늘은 정말 느긋하게 지나가는 날이에요.",
    tags: ["뇌 셔터 내림", "피곤 구독중", "현관 탈주 불가형"],
    summary:
      "알람이 울리면 5~10분 더 잠에 빠져드는 하루, 오늘은 그럴만한 날이에요.\n머릿속은 셔터가 내려간 것 같고 피로함이 가득하며 어깨와 목은 뭉쳐 있는 것 같아요.\n딱히 힘든 일은 없지만 그냥 하루를 버티며 지나가는 느낌이에요. 오늘은 좀 느리게 흘러가도 괜찮으니, 스스로에게 여유를 허락해 주세요.",
    recommends: [
      {
        badge: "휴식",
        title: "소파에서 잠깐 휴식 취하기",
        desc: "소파에 누워 잠깐 쉬어 보세요. 짧은 낮잠이 뇌의 피로를 풀어줄 수 있어요.\n몸이 느리게 움직일 때, 작은 휴식이 큰 도움이 됩니다.",
      },
      {
        badge: "활동",
        title: "가벼운 스트레칭하기",
        desc: "짧은 스트레칭으로 몸을 풀어 보세요. 혈액순환이 좋아지면 피로감도 덜 느껴질 수 있어요.\n잠깐의 운동이 오늘 컨디션을 살려줄 거예요.",
      },
      {
        badge: "마음 챙김",
        title: "짧은 명상 시간 가지기",
        desc: "5분만 조용히 앉아 호흡에 집중해 보세요. 마음이 한결 편해질 거예요.\n마음이 가벼워지면 피로감도 줄어들 수 있습니다.",
      },
    ],
  },
  Slow: {
    title: "집에 가고 싶어 미칠 것 같음",
    desc: "천천히 가도 괜찮아요. 오늘은 속도를 낮춰 보세요.",
    tags: ["에너지 절약 모드", "업무 과부하", "어딘가 아픈 것 같아"],
  },
  Lazy: {
    title: "오늘은 누움 전문가",
    desc: "무리하지 마세요. 충분한 휴식이 필요한 날이에요.",
    tags: ["중력 2배", "이불 속 천국", "알람 무시형"],
  },
  LayLay: {
    title: "완전 LayLay 모드 달성",
    desc: "오늘은 세상과 잠시 이별해도 괜찮아요.",
