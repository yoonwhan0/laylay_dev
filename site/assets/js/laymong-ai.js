...
(function () {
  ...
  var MOCK = {
    ...
    총론설명:
      '오늘 꿈은 "번쩍 빛나는 하루"라기보다, 살짝 기울어진 균형을 바로잡는 연습하기 좋은 메시지에 가까워요. 꿈 속 감정과 오늘의 기분을 연결해 보면, 크게 흔들리기보다는 작은 조정으로 하루를 만들어가면 편해요. 재물·관계·일·몸 네 축 모두 "과하지 않게, 꾸준하게"가 답이에요. 불안이 남아 있다면 그것도 하루를 더 세밀하게 살피게 해주는 신호로 받아들여도 괜찮아요. 오늘 저녁에는 스스로에게 "충분히 잘하셨어요" 한마디만 남겨 보세요. 작은 여유가 내일의 운을 조금 더 부드럽게 만들어줄 거예요.',
  ...
  async function fetchDream(form) {
    ...
    var laymongSystem = [
      ...
      '말투: 정중한 해요체·습니다체로 일관하세요. 반말(해, 야, 해봐, 거야, 하자 등)은 금지합니다. 따뜻하되 공손하게, 문장에 리듬이 있게 씁니다.',
